...
Uses **`web-ifc@0.0.77`** directly (same approach as StructAI) — NOT the broken `web-ifc-viewer` package.
...
### Fix
**Ditched `web-ifc-viewer` entirely.** Switched to the same approach as the working StructAI project:
